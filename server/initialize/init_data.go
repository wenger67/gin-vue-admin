...
func InitExaFileUploadAndDownload() (err error) {
	...
	insert := []model.ExaFileUploadAndDownload{
		...
		{Model: gorm.Model{ID: 1, CreatedAt: time.Date(2020, 9, 1, 7, 25, 9, 428, time.Local),
			...
			Url: "http://127.0.0.1:8888/upload/2020_09_01/1/181/690/5fcd045ef544ff97a73d675eda6e267c_IMG_20200901_150733_253.jpg",
			Tag: "jpg", RecordId: 1},
		{Model: gorm.Model{ID: 2, CreatedAt: time.Date(2020, 9, 1, 7, 25, 9, 306, time.Local),
			...
			Url: "http://127.0.0.1:8888/upload/2020_09_01/1/181/690/5fcd045ef544ff97a73d675eda6e267c_IMG_20200901_150733_379.jpg",
			Tag: "jpg", RecordId: 1},
		{Model: gorm.Model{ID: 3, CreatedAt: time.Date(2020, 9, 1, 7, 25, 9, 551, time.Local),
			...
			Url: "http://127.0.0.1:8888/upload/2020_09_01/1/181/690/5fcd045ef544ff97a73d675eda6e267c_IMG_20200901_150733_505.jpg",
			Tag: "jpg", RecordId: 1},
		{Model: gorm.Model{ID: 4, CreatedAt: time.Date(2020, 9, 1, 7, 25, 9, 0, time.Local),
			UpdatedAt: time.Date(2020, 9, 1, 7, 25, 9, 0, time.Local)}, Name: "VID_20200901_150629.mp4",
			Url: "http://127.0.0.1:8888/upload/2020_09_01/1/181/690/5fcd045ef544ff97a73d675eda6e267c_VID_20200901_150629.mp4",
			Tag: "mp4", RecordId: 1},
		{Model: gorm.Model{ID: 5, CreatedAt: time.Date(2020, 9, 1, 7, 25, 9, 672, time.Local),
			...
			Url: "http://127.0.0.1:8888/upload/2020_09_01/1/181/690/5fcd045ef544ff97a73d675eda6e267c_IMG_20200901_150733_633.jpg",
			Tag: "jpg", RecordId: 1},
		...
		{Model: gorm.Model{ID: 6, CreatedAt: time.Date(2020, 9, 1, 7, 26, 4, 183, time.Local),
			...
			Url: "http://127.0.0.1:8888/upload/2020_09_01/1/181/659/035481d112ae20ec69b180a987f8fd0f_IMG_20200901_141007_589.jpg",
			Tag: "jpg", RecordId: 4},
		{Model: gorm.Model{ID: 7, CreatedAt: time.Date(2020, 9, 1, 7, 26, 4, 305, time.Local),
			...
			Url: "http://127.0.0.1:8888/upload/2020_09_01/1/181/659/035481d112ae20ec69b180a987f8fd0f_IMG_20200901_141007_709.jpg",
			Tag: "jpg", RecordId: 4},
		{Model: gorm.Model{ID: 8, CreatedAt: time.Date(2020, 9, 1, 7, 25, 9, 551, time.Local),
			...
			Url: "http://127.0.0.1:8888/upload/2020_09_01/1/181/659/035481d112ae20ec69b180a987f8fd0f_IMG_20200901_141007_837.jpg",
			Tag: "jpg", RecordId: 4},
		{Model: gorm.Model{ID: 10, CreatedAt: time.Date(2020, 9, 1, 7, 25, 9, 672, time.Local),
			...
			Url: "http://127.0.0.1:8888/upload/2020_09_01/1/181/659/035481d112ae20ec69b180a987f8fd0f_IMG_20200901_141007_979.jpg",
			Tag: "jpg", RecordId: 4},
		...
		{Model: gorm.Model{ID: 11, CreatedAt: time.Date(2020, 9, 1, 7, 15, 9, 428, time.Local),
			...
			Url: "http://127.0.0.1:8888/upload/2020_09_01/1/181/658/3d29316d13de4c7ff0f4f8466741e2a8_IMG_20200901_140627_663.jpg",
			Tag: "jpg", TroubleId: 1},
		{Model: gorm.Model{ID: 12, CreatedAt: time.Date(2020, 9, 1, 7, 25, 9, 306, time.Local),
			...
			Url: "http://127.0.0.1:8888/upload/2020_09_01/1/181/658/3d29316d13de4c7ff0f4f8466741e2a8_IMG_20200901_140627_787.jpg",
			Tag: "jpg", TroubleId: 1},
		{Model: gorm.Model{ID: 13, CreatedAt: time.Date(2020, 9, 1, 7, 25, 9, 551, time.Local),
			...
			Url: "http://127.0.0.1:8888/upload/2020_09_01/1/181/658/3d29316d13de4c7ff0f4f8466741e2a8_IMG_20200901_140627_919.jpg",
			Tag: "jpg", TroubleId: 1},
		{Model: gorm.Model{ID: 15, CreatedAt: time.Date(2020, 9, 1, 7, 25, 9, 672, time.Local),
			...
			Url: "http://127.0.0.1:8888/upload/2020_09_01/1/181/658/3d29316d13de4c7ff0f4f8466741e2a8_IMG_20200901_140628_046.jpg",
			Tag: "jpg", TroubleId: 1},
	}
	if tx.Create(&insert).Error != nil { // 遇到错误时回滚事务
		tx.Rollback()
...
func InitSysBaseMenus() (err error) {
	...
	insert := []model.SysBaseMenu{
		...
		{Model: gorm.Model{ID: 33, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "19",
			Path: "breakpoint", Name: "breakpoint", Hidden: false, Component: "view/example/breakpoint/breakpoint.vue", Sort: 6, Meta: model.Meta{KeepAlive: false, DefaultMenu: false, Title: "断点续传", Icon: "upload"}},
...
func InitLiftTrouble() (err error) {
	...
	insert := []model.LiftTrouble{
		{Model: gorm.Model{ID: 1, CreatedAt: time.Date(2020, 8, 20, 12, 23, 0, 0, time.Local),
			...
			RecorderId: 2, FeedbackContent: "good", FeedbackRate: 4.75, Progress: 6},
		{Model: gorm.Model{ID: 2, CreatedAt: time.Date(2020, 8, 20, 12, 23, 0, 0, time.Local),
			UpdatedAt: time.Date(2020, 8, 20, 14, 20, 0, 0, time.Local)}, LiftId: 1,
		...
		{Model: gorm.Model{ID: 6, CreatedAt: time.Date(2020, 8, 20, 12, 23, 0, 0, time.Local),
			...
			FixTime: time.Date(2020, 8, 20, 13, 35, 0, 0, time.Local), FixUserId: 18,
			FixCategoryId: uint(enum.TroubleSolvedByReplaceCell), ReasonCategoryId: uint(enum.TroubleReasonAsAge),
			FeedbackContent: "good", FeedbackRate: 3.45, Progress: 5},
	}
	if err := tx.Create(&insert).Error; err != nil {
		tx.Rollback()
		return err
