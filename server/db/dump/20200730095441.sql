...
CREATE TABLE `categories` (
  ...
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
  `category_subject_id` int(11) DEFAULT NULL,
...
CREATE TABLE `category_subjects` (
  ...
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
  `subject_name` varchar(255) DEFAULT NULL COMMENT '类别主体名',
  PRIMARY KEY (`id`),
...
CREATE TABLE `lift_models` (
  ...
  `brand` varchar(255) DEFAULT NULL COMMENT '电梯品牌',
  `modal` varchar(255) DEFAULT NULL COMMENT '电梯型号',
...
CREATE TABLE `lift_troubles` (
  ...
  `deleted_at` datetime DEFAULT NULL,
  `lift_id` int(11) DEFAULT NULL,
  `from_category_id` int(11) DEFAULT NULL,
  `start_time` datetime DEFAULT NULL,
  `start_user_id` int(11) DEFAULT NULL,
  `response_time` datetime DEFAULT NULL,
  `response_user_id` int(11) DEFAULT NULL,
  `scene_time` datetime DEFAULT NULL,
  `scene_user_id` int(11) DEFAULT NULL,
  `fix_time` datetime DEFAULT NULL,
  `fix_user_id` int(11) DEFAULT NULL,
  `fix_category_id` int(11) DEFAULT NULL,
...
CREATE TABLE `lifts` (
  ...
  `lift_model_id` int(11) DEFAULT NULL,
  `category_id` int(11) DEFAULT NULL,
  ...
  `ad_device_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `sys_authority_menus` VALUES ('888',1),('888',2),('888',3),('888',4),('888',5),('888',6),('888',17),('888',18),('888',19),('888',20),('888',21),('888',22),('888',23),('888',26),('888',33),('888',34),('888',38),('888',40),('888',41),('888',42),('888',50),('888',51),('888',52),('8881',1),('8881',2),('8881',18),('8881',38),('8881',40),('8881',41),('8881',42),('9528',1),('9528',2),('9528',3),('9528',4),('9528',5),('9528',6),('9528',17),('9528',18),('9528',19),('9528',20),('9528',21),('9528',22),('9528',23),('9528',26),('9528',33),('9528',34),('9528',38),('9528',40),('9528',41),('9528',42);
...
INSERT INTO `sys_base_menus` VALUES (1,'2019-09-19 14:05:18','2020-05-30 07:43:06',NULL,0,0,'dashboard','dashboard',0,'view/dashboard/index.vue','仪表盘','setting','仪表盘',1,0,0),(2,'2019-09-19 14:06:17','2020-05-10 13:31:50',NULL,0,0,'about','about',0,'view/about/index.vue','关于我们','info','测试菜单',7,0,0),(3,'2019-09-19 14:06:38','2020-04-24 02:16:43',NULL,0,0,'admin','superAdmin',0,'view/superAdmin/index.vue','超级管理员','user-solid','超级管理员',3,0,0),(4,'2019-09-19 14:11:53','2020-05-30 07:43:25',NULL,0,3,'authority','authority',0,'view/superAdmin/authority/authority.vue','角色管理','s-custom','角色管理',1,0,0),(5,'2019-09-19 14:13:18','2020-04-30 09:45:27',NULL,0,3,'menu','menu',0,'view/superAdmin/menu/menu.vue','菜单管理','s-order','菜单管理',2,1,0),(6,'2019-09-19 14:13:36','2020-04-24 02:16:43',NULL,0,3,'api','api',0,'view/superAdmin/api/api.vue','api管理','s-platform','api管理',3,1,0),(17,'2019-10-09 07:12:29','2020-04-24 02:16:43',NULL,0,3,'user','user',0,'view/superAdmin/user/user.vue','用户管理','coordinate','用户管理',4,0,0),(18,'2019-10-15 14:27:22','2020-05-10 13:31:36',NULL,0,0,'person','person',1,'view/person/person.vue','个人信息','message-solid','个人信息',4,0,0),(19,'2019-10-20 03:14:42','2020-04-24 02:16:43',NULL,0,0,'example','example',0,'view/example/index.vue','示例文件','s-management','示例文件',6,0,0),(20,'2019-10-20 03:18:11','2020-04-24 02:16:42',NULL,0,19,'table','table',0,'view/example/table/table.vue','表格示例','s-order','表格示例',1,0,0),(21,'2019-10-20 03:19:52','2020-04-24 02:16:43',NULL,0,19,'form','form',0,'view/example/form/form.vue','表单示例','document','表单示例',2,0,0),(22,'2019-10-20 03:22:19','2020-04-24 02:16:43',NULL,0,19,'rte','rte',0,'view/example/rte/rte.vue','富文本编辑器','reading','富文本编辑器',3,0,0),(23,'2019-10-20 03:23:39','2020-04-24 02:16:43',NULL,0,19,'excel','excel',0,'view/example/excel/excel.vue','excel导入导出','s-marketing','excel导入导出',4,0,0),(26,'2019-10-20 03:27:02','2020-04-24 02:16:43',NULL,0,19,'upload','upload',0,'view/example/upload/upload.vue','上传下载','upload','上传下载',5,0,0),(33,'2020-02-17 08:20:47','2020-04-24 02:16:43',NULL,0,19,'breakpoint','breakpoint',0,'view/example/breakpoint/breakpoint.vue','断点续传','upload','断点续传',6,0,0),(34,'2020-02-24 11:48:37','2020-04-24 02:16:43',NULL,0,19,'customer','customer',0,'view/example/customer/customer.vue','客户列表（资源示例）','s-custom','客户列表（资源示例）',7,0,0),(38,'2020-03-29 13:31:03','2020-04-24 02:16:43',NULL,0,0,'systemTools','systemTools',0,'view/systemTools/index.vue','系统工具','s-cooperation','系统工具',5,0,0),(40,'2020-03-29 13:35:10','2020-05-03 13:38:49',NULL,0,38,'autoCode','autoCode',0,'view/systemTools/autoCode/index.vue','代码生成器','cpu','代码生成器',1,1,0),(41,'2020-03-29 13:36:26','2020-05-03 13:38:43',NULL,0,38,'formCreate','formCreate',0,'view/systemTools/formCreate/index.vue','表单生成器','magic-stick','表单生成器',2,1,0),(42,'2020-04-02 06:19:36','2020-04-24 02:16:43',NULL,0,38,'system','system',0,'view/systemTools/system/system.vue','系统配置','s-operation','系统配置',3,0,0),(45,'2020-04-29 09:19:34','2020-07-04 10:27:22',NULL,0,0,'iconList','iconList',0,'view/iconList/index.vue','图标集合','star-on',NULL,2,0,0),(50,'2020-06-24 11:49:54','2020-06-28 12:34:47',NULL,0,3,'dictionary','dictionary',0,'view/superAdmin/dictionary/sysDictionary.vue','字典管理','notebook-2',NULL,5,0,0),(51,'2020-06-24 11:51:33','2020-06-28 12:35:04',NULL,0,3,'dictionaryDetail/:id','dictionaryDetail',1,'view/superAdmin/dictionary/sysDictionaryDetail.vue','字典详情','s-order',NULL,1,0,0),(52,'2020-06-29 05:31:17','2020-07-07 08:05:34',NULL,0,3,'operation','operation',0,'view/superAdmin/operation/sysOperationRecord.vue','操作历史','time',NULL,6,0,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=356 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_operation_records` VALUES (342,'2020-07-30 09:47:15','2020-07-30 09:47:15',NULL,'127.0.0.1','GET','/autoCode/getDB',200,313446,'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:78.0) Gecko/20100101 Firefox/78.0','','',10,'{\"code\":0,\"data\":{\"dbs\":[{\"database\":\"information_schema\"},{\"database\":\"mysql\"},{\"database\":\"performance_schema\"},{\"database\":\"qmPlus\"},{\"database\":\"sys\"}]},\"msg\":\"操作成功\"}'),(343,'2020-07-30 09:47:15','2020-07-30 09:47:15',NULL,'127.0.0.1','GET','/sysDictionary/findSysDictionary',200,761037,'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:78.0) Gecko/20100101 Firefox/78.0','','',10,'{\"code\":0,\"data\":{\"resysDictionary\":{\"ID\":5,\"CreatedAt\":\"2020-07-05T15:34:23+08:00\",\"UpdatedAt\":\"2020-07-05T15:52:45+08:00\",\"DeletedAt\":null,\"name\":\"数据库浮点型\",\"type\":\"float64\",\"status\":true,\"desc\":\"数据库浮点型\",\"sysDictionaryDetails\":[{\"ID\":24,\"CreatedAt\":\"2020-07-05T15:34:30+08:00\",\"UpdatedAt\":\"2020-07-05T15:34:30+08:00\",\"DeletedAt\":null,\"label\":\"float\",\"value\":0,\"status\":true,\"sort\":0,\"sysDictionaryID\":5},{\"ID\":25,\"CreatedAt\":\"2020-07-05T15:34:35+08:00\",\"UpdatedAt\":\"2020-07-05T15:34:35+08:00\",\"DeletedAt\":null,\"label\":\"double\",\"value\":1,\"status\":true,\"sort\":1,\"sysDictionaryID\":5},{\"ID\":26,\"CreatedAt\":\"2020-07-05T15:34:41+08:00\",\"UpdatedAt\":\"2020-07-05T15:34:41+08:00\",\"DeletedAt\":null,\"label\":\"decimal\",\"value\":2,\"status\":true,\"sort\":2,\"sysDictionaryID\":5}]}},\"msg\":\"操作成功\"}'),(344,'2020-07-30 09:47:15','2020-07-30 09:47:15',NULL,'127.0.0.1','GET','/sysDictionary/findSysDictionary',200,412391,'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:78.0) Gecko/20100101 Firefox/78.0','','',10,'{\"code\":0,\"data\":{\"resysDictionary\":{\"ID\":7,\"CreatedAt\":\"2020-07-05T15:36:48+08:00\",\"UpdatedAt\":\"2020-07-05T15:36:48+08:00\",\"DeletedAt\":null,\"name\":\"数据库bool类型\",\"type\":\"bool\",\"status\":true,\"desc\":\"数据库bool类型\",\"sysDictionaryDetails\":[{\"ID\":27,\"CreatedAt\":\"2020-07-05T15:37:45+08:00\",\"UpdatedAt\":\"2020-07-05T15:37:45+08:00\",\"DeletedAt\":null,\"label\":\"tinyint\",\"value\":0,\"status\":true,\"sort\":0,\"sysDictionaryID\":7}]}},\"msg\":\"操作成功\"}'),(345,'2020-07-30 09:47:15','2020-07-30 09:47:15',NULL,'127.0.0.1','GET','/sysDictionary/findSysDictionary',200,565504,'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:78.0) Gecko/20100101 Firefox/78.0','','',10,'{\"code\":0,\"data\":{\"resysDictionary\":{\"ID\":3,\"CreatedAt\":\"2020-07-05T15:27:31+08:00\",\"UpdatedAt\":\"2020-07-05T15:27:31+08:00\",\"DeletedAt\":null,\"name\":\"数据库int类型\",\"type\":\"int\",\"status\":true,\"desc\":\"int类型对应的数据库类型\",\"sysDictionaryDetails\":[{\"ID\":12,\"CreatedAt\":\"2020-07-05T15:31:41+08:00\",\"UpdatedAt\":\"2020-07-05T15:31:41+08:00\",\"DeletedAt\":null,\"label\":\"smallint\",\"value\":1,\"status\":true,\"sort\":1,\"sysDictionaryID\":3},{\"ID\":13,\"CreatedAt\":\"2020-07-05T15:31:52+08:00\",\"UpdatedAt\":\"2020-07-05T15:31:52+08:00\",\"DeletedAt\":null,\"label\":\"mediumint\",\"value\":2,\"status\":true,\"sort\":2,\"sysDictionaryID\":3},{\"ID\":14,\"CreatedAt\":\"2020-07-05T15:32:04+08:00\",\"UpdatedAt\":\"2020-07-05T15:32:04+08:00\",\"DeletedAt\":null,\"label\":\"int\",\"value\":3,\"status\":true,\"sort\":3,\"sysDictionaryID\":3},{\"ID\":15,\"CreatedAt\":\"2020-07-05T15:32:11+08:00\",\"UpdatedAt\":\"2020-07-05T15:32:11+08:00\",\"DeletedAt\":null,\"label\":\"bigint\",\"value\":4,\"status\":true,\"sort\":4,\"sysDictionaryID\":3}]}},\"msg\":\"操作成功\"}'),(346,'2020-07-30 09:47:15','2020-07-30 09:47:15',NULL,'127.0.0.1','GET','/sysDictionary/findSysDictionary',200,627764,'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:78.0) Gecko/20100101 Firefox/78.0','','',10,'{\"code\":0,\"data\":{\"resysDictionary\":{\"ID\":6,\"CreatedAt\":\"2020-07-05T15:35:05+08:00\",\"UpdatedAt\":\"2020-07-05T15:35:05+08:00\",\"DeletedAt\":null,\"name\":\"数据库字符串\",\"type\":\"string\",\"status\":true,\"desc\":\"数据库字符串\",\"sysDictionaryDetails\":[{\"ID\":28,\"CreatedAt\":\"2020-07-05T15:53:25+08:00\",\"UpdatedAt\":\"2020-07-05T15:53:25+08:00\",\"DeletedAt\":null,\"label\":\"char\",\"value\":0,\"status\":true,\"sort\":0,\"sysDictionaryID\":6},{\"ID\":29,\"CreatedAt\":\"2020-07-05T15:53:29+08:00\",\"UpdatedAt\":\"2020-07-05T15:53:29+08:00\",\"DeletedAt\":null,\"label\":\"varchar\",\"value\":1,\"status\":true,\"sort\":1,\"sysDictionaryID\":6},{\"ID\":30,\"CreatedAt\":\"2020-07-05T15:53:35+08:00\",\"UpdatedAt\":\"2020-07-05T15:53:35+08:00\",\"DeletedAt\":null,\"label\":\"tinyblob\",\"value\":2,\"status\":true,\"sort\":2,\"sysDictionaryID\":6},{\"ID\":31,\"CreatedAt\":\"2020-07-05T15:53:40+08:00\",\"UpdatedAt\":\"2020-07-05T15:53:40+08:00\",\"DeletedAt\":null,\"label\":\"tinytext\",\"value\":3,\"status\":true,\"sort\":3,\"sysDictionaryID\":6},{\"ID\":32,\"CreatedAt\":\"2020-07-05T15:53:48+08:00\",\"UpdatedAt\":\"2020-07-05T15:53:48+08:00\",\"DeletedAt\":null,\"label\":\"text\",\"value\":4,\"status\":true,\"sort\":4,\"sysDictionaryID\":6},{\"ID\":33,\"CreatedAt\":\"2020-07-05T15:53:55+08:00\",\"UpdatedAt\":\"2020-07-05T15:53:55+08:00\",\"DeletedAt\":null,\"label\":\"blob\",\"value\":5,\"status\":true,\"sort\":5,\"sysDictionaryID\":6},{\"ID\":34,\"CreatedAt\":\"2020-07-05T15:54:02+08:00\",\"UpdatedAt\":\"2020-07-05T15:54:02+08:00\",\"DeletedAt\":null,\"label\":\"mediumblob\",\"value\":6,\"status\":true,\"sort\":6,\"sysDictionaryID\":6},{\"ID\":35,\"CreatedAt\":\"2020-07-05T15:54:09+08:00\",\"UpdatedAt\":\"2020-07-05T15:54:09+08:00\",\"DeletedAt\":null,\"label\":\"mediumtext\",\"value\":7,\"status\":true,\"sort\":7,\"sysDictionaryID\":6},{\"ID\":36,\"CreatedAt\":\"2020-07-05T15:54:16+08:00\",\"UpdatedAt\":\"2020-07-05T15:54:16+08:00\",\"DeletedAt\":null,\"label\":\"longblob\",\"value\":8,\"status\":true,\"sort\":8,\"sysDictionaryID\":6},{\"ID\":37,\"CreatedAt\":\"2020-07-05T15:54:24+08:00\",\"UpdatedAt\":\"2020-07-05T15:54:24+08:00\",\"DeletedAt\":null,\"label\":\"longtext\",\"value\":9,\"status\":true,\"sort\":9,\"sysDictionaryID\":6}]}},\"msg\":\"操作成功\"}'),(347,'2020-07-30 09:47:15','2020-07-30 09:47:15',NULL,'127.0.0.1','GET','/sysDictionary/findSysDictionary',200,389160607,'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:78.0) Gecko/20100101 Firefox/78.0','','',10,'{\"code\":0,\"data\":{\"resysDictionary\":{\"ID\":4,\"CreatedAt\":\"2020-07-05T15:33:07+08:00\",\"UpdatedAt\":\"2020-07-05T16:07:18+08:00\",\"DeletedAt\":null,\"name\":\"数据库时间日期类型\",\"type\":\"time.Time\",\"status\":true,\"desc\":\"数据库时间日期类型\",\"sysDictionaryDetails\":[{\"ID\":19,\"CreatedAt\":\"2020-07-05T15:33:16+08:00\",\"UpdatedAt\":\"2020-07-05T15:33:16+08:00\",\"DeletedAt\":null,\"label\":\"data\",\"value\":0,\"status\":true,\"sort\":0,\"sysDictionaryID\":4},{\"ID\":20,\"CreatedAt\":\"2020-07-05T15:33:21+08:00\",\"UpdatedAt\":\"2020-07-05T15:33:21+08:00\",\"DeletedAt\":null,\"label\":\"time\",\"value\":1,\"status\":true,\"sort\":1,\"sysDictionaryID\":4},{\"ID\":21,\"CreatedAt\":\"2020-07-05T15:33:25+08:00\",\"UpdatedAt\":\"2020-07-05T15:33:25+08:00\",\"DeletedAt\":null,\"label\":\"year\",\"value\":2,\"status\":true,\"sort\":2,\"sysDictionaryID\":4},{\"ID\":22,\"CreatedAt\":\"2020-07-05T15:33:35+08:00\",\"UpdatedAt\":\"2020-07-05T15:33:35+08:00\",\"DeletedAt\":null,\"label\":\"datetime\",\"value\":3,\"status\":true,\"sort\":3,\"sysDictionaryID\":4},{\"ID\":23,\"CreatedAt\":\"2020-07-05T15:33:42+08:00\",\"UpdatedAt\":\"2020-07-05T15:33:42+08:00\",\"DeletedAt\":null,\"label\":\"timestamp\",\"value\":5,\"status\":true,\"sort\":5,\"sysDictionaryID\":4}]}},\"msg\":\"操作成功\"}'),(348,'2020-07-30 09:47:20','2020-07-30 09:47:20',NULL,'127.0.0.1','GET','/autoCode/getTables',200,528276,'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:78.0) Gecko/20100101 Firefox/78.0','','',10,'{\"code\":0,\"data\":{\"tables\":[{\"tableName\":\"authority_menu\"},{\"tableName\":\"casbin_rule\"},{\"tableName\":\"exa_customers\"},{\"tableName\":\"exa_file_chunks\"},{\"tableName\":\"exa_file_upload_and_downloads\"},{\"tableName\":\"exa_files\"},{\"tableName\":\"jwt_blacklists\"},{\"tableName\":\"sys_apis\"},{\"tableName\":\"sys_authorities\"},{\"tableName\":\"sys_authority_menus\"},{\"tableName\":\"sys_base_menus\"},{\"tableName\":\"sys_data_authority_id\"},{\"tableName\":\"sys_dictionaries\"},{\"tableName\":\"sys_dictionary_details\"},{\"tableName\":\"sys_operation_records\"},{\"tableName\":\"sys_users\"},{\"tableName\":\"sys_workflow_step_infos\"},{\"tableName\":\"sys_workflows\"}]},\"msg\":\"操作成功\"}'),(349,'2020-07-30 09:49:50','2020-07-30 09:49:50',NULL,'127.0.0.1','GET','/autoCode/getDB',200,257546,'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:78.0) Gecko/20100101 Firefox/78.0','','',10,'{\"code\":0,\"data\":{\"dbs\":[{\"database\":\"information_schema\"},{\"database\":\"mysql\"},{\"database\":\"performance_schema\"},{\"database\":\"qmPlus\"},{\"database\":\"sys\"}]},\"msg\":\"操作成功\"}'),(350,'2020-07-30 09:49:50','2020-07-30 09:49:50',NULL,'127.0.0.1','GET','/sysDictionary/findSysDictionary',200,1037180,'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:78.0) Gecko/20100101 Firefox/78.0','','',10,'{\"code\":0,\"data\":{\"resysDictionary\":{\"ID\":6,\"CreatedAt\":\"2020-07-05T15:35:05+08:00\",\"UpdatedAt\":\"2020-07-05T15:35:05+08:00\",\"DeletedAt\":null,\"name\":\"数据库字符串\",\"type\":\"string\",\"status\":true,\"desc\":\"数据库字符串\",\"sysDictionaryDetails\":[{\"ID\":28,\"CreatedAt\":\"2020-07-05T15:53:25+08:00\",\"UpdatedAt\":\"2020-07-05T15:53:25+08:00\",\"DeletedAt\":null,\"label\":\"char\",\"value\":0,\"status\":true,\"sort\":0,\"sysDictionaryID\":6},{\"ID\":29,\"CreatedAt\":\"2020-07-05T15:53:29+08:00\",\"UpdatedAt\":\"2020-07-05T15:53:29+08:00\",\"DeletedAt\":null,\"label\":\"varchar\",\"value\":1,\"status\":true,\"sort\":1,\"sysDictionaryID\":6},{\"ID\":30,\"CreatedAt\":\"2020-07-05T15:53:35+08:00\",\"UpdatedAt\":\"2020-07-05T15:53:35+08:00\",\"DeletedAt\":null,\"label\":\"tinyblob\",\"value\":2,\"status\":true,\"sort\":2,\"sysDictionaryID\":6},{\"ID\":31,\"CreatedAt\":\"2020-07-05T15:53:40+08:00\",\"UpdatedAt\":\"2020-07-05T15:53:40+08:00\",\"DeletedAt\":null,\"label\":\"tinytext\",\"value\":3,\"status\":true,\"sort\":3,\"sysDictionaryID\":6},{\"ID\":32,\"CreatedAt\":\"2020-07-05T15:53:48+08:00\",\"UpdatedAt\":\"2020-07-05T15:53:48+08:00\",\"DeletedAt\":null,\"label\":\"text\",\"value\":4,\"status\":true,\"sort\":4,\"sysDictionaryID\":6},{\"ID\":33,\"CreatedAt\":\"2020-07-05T15:53:55+08:00\",\"UpdatedAt\":\"2020-07-05T15:53:55+08:00\",\"DeletedAt\":null,\"label\":\"blob\",\"value\":5,\"status\":true,\"sort\":5,\"sysDictionaryID\":6},{\"ID\":34,\"CreatedAt\":\"2020-07-05T15:54:02+08:00\",\"UpdatedAt\":\"2020-07-05T15:54:02+08:00\",\"DeletedAt\":null,\"label\":\"mediumblob\",\"value\":6,\"status\":true,\"sort\":6,\"sysDictionaryID\":6},{\"ID\":35,\"CreatedAt\":\"2020-07-05T15:54:09+08:00\",\"UpdatedAt\":\"2020-07-05T15:54:09+08:00\",\"DeletedAt\":null,\"label\":\"mediumtext\",\"value\":7,\"status\":true,\"sort\":7,\"sysDictionaryID\":6},{\"ID\":36,\"CreatedAt\":\"2020-07-05T15:54:16+08:00\",\"UpdatedAt\":\"2020-07-05T15:54:16+08:00\",\"DeletedAt\":null,\"label\":\"longblob\",\"value\":8,\"status\":true,\"sort\":8,\"sysDictionaryID\":6},{\"ID\":37,\"CreatedAt\":\"2020-07-05T15:54:24+08:00\",\"UpdatedAt\":\"2020-07-05T15:54:24+08:00\",\"DeletedAt\":null,\"label\":\"longtext\",\"value\":9,\"status\":true,\"sort\":9,\"sysDictionaryID\":6}]}},\"msg\":\"操作成功\"}'),(351,'2020-07-30 09:49:50','2020-07-30 09:49:50',NULL,'127.0.0.1','GET','/sysDictionary/findSysDictionary',200,750849,'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:78.0) Gecko/20100101 Firefox/78.0','','',10,'{\"code\":0,\"data\":{\"resysDictionary\":{\"ID\":5,\"CreatedAt\":\"2020-07-05T15:34:23+08:00\",\"UpdatedAt\":\"2020-07-05T15:52:45+08:00\",\"DeletedAt\":null,\"name\":\"数据库浮点型\",\"type\":\"float64\",\"status\":true,\"desc\":\"数据库浮点型\",\"sysDictionaryDetails\":[{\"ID\":24,\"CreatedAt\":\"2020-07-05T15:34:30+08:00\",\"UpdatedAt\":\"2020-07-05T15:34:30+08:00\",\"DeletedAt\":null,\"label\":\"float\",\"value\":0,\"status\":true,\"sort\":0,\"sysDictionaryID\":5},{\"ID\":25,\"CreatedAt\":\"2020-07-05T15:34:35+08:00\",\"UpdatedAt\":\"2020-07-05T15:34:35+08:00\",\"DeletedAt\":null,\"label\":\"double\",\"value\":1,\"status\":true,\"sort\":1,\"sysDictionaryID\":5},{\"ID\":26,\"CreatedAt\":\"2020-07-05T15:34:41+08:00\",\"UpdatedAt\":\"2020-07-05T15:34:41+08:00\",\"DeletedAt\":null,\"label\":\"decimal\",\"value\":2,\"status\":true,\"sort\":2,\"sysDictionaryID\":5}]}},\"msg\":\"操作成功\"}'),(352,'2020-07-30 09:49:50','2020-07-30 09:49:50',NULL,'127.0.0.1','GET','/sysDictionary/findSysDictionary',200,236738815,'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:78.0) Gecko/20100101 Firefox/78.0','','',10,'{\"code\":0,\"data\":{\"resysDictionary\":{\"ID\":4,\"CreatedAt\":\"2020-07-05T15:33:07+08:00\",\"UpdatedAt\":\"2020-07-05T16:07:18+08:00\",\"DeletedAt\":null,\"name\":\"数据库时间日期类型\",\"type\":\"time.Time\",\"status\":true,\"desc\":\"数据库时间日期类型\",\"sysDictionaryDetails\":[{\"ID\":19,\"CreatedAt\":\"2020-07-05T15:33:16+08:00\",\"UpdatedAt\":\"2020-07-05T15:33:16+08:00\",\"DeletedAt\":null,\"label\":\"data\",\"value\":0,\"status\":true,\"sort\":0,\"sysDictionaryID\":4},{\"ID\":20,\"CreatedAt\":\"2020-07-05T15:33:21+08:00\",\"UpdatedAt\":\"2020-07-05T15:33:21+08:00\",\"DeletedAt\":null,\"label\":\"time\",\"value\":1,\"status\":true,\"sort\":1,\"sysDictionaryID\":4},{\"ID\":21,\"CreatedAt\":\"2020-07-05T15:33:25+08:00\",\"UpdatedAt\":\"2020-07-05T15:33:25+08:00\",\"DeletedAt\":null,\"label\":\"year\",\"value\":2,\"status\":true,\"sort\":2,\"sysDictionaryID\":4},{\"ID\":22,\"CreatedAt\":\"2020-07-05T15:33:35+08:00\",\"UpdatedAt\":\"2020-07-05T15:33:35+08:00\",\"DeletedAt\":null,\"label\":\"datetime\",\"value\":3,\"status\":true,\"sort\":3,\"sysDictionaryID\":4},{\"ID\":23,\"CreatedAt\":\"2020-07-05T15:33:42+08:00\",\"UpdatedAt\":\"2020-07-05T15:33:42+08:00\",\"DeletedAt\":null,\"label\":\"timestamp\",\"value\":5,\"status\":true,\"sort\":5,\"sysDictionaryID\":4}]}},\"msg\":\"操作成功\"}'),(353,'2020-07-30 09:49:50','2020-07-30 09:49:50',NULL,'127.0.0.1','GET','/sysDictionary/findSysDictionary',200,239394554,'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:78.0) Gecko/20100101 Firefox/78.0','','',10,'{\"code\":0,\"data\":{\"resysDictionary\":{\"ID\":7,\"CreatedAt\":\"2020-07-05T15:36:48+08:00\",\"UpdatedAt\":\"2020-07-05T15:36:48+08:00\",\"DeletedAt\":null,\"name\":\"数据库bool类型\",\"type\":\"bool\",\"status\":true,\"desc\":\"数据库bool类型\",\"sysDictionaryDetails\":[{\"ID\":27,\"CreatedAt\":\"2020-07-05T15:37:45+08:00\",\"UpdatedAt\":\"2020-07-05T15:37:45+08:00\",\"DeletedAt\":null,\"label\":\"tinyint\",\"value\":0,\"status\":true,\"sort\":0,\"sysDictionaryID\":7}]}},\"msg\":\"操作成功\"}'),(354,'2020-07-30 09:49:50','2020-07-30 09:49:50',NULL,'127.0.0.1','GET','/sysDictionary/findSysDictionary',200,239174906,'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:78.0) Gecko/20100101 Firefox/78.0','','',10,'{\"code\":0,\"data\":{\"resysDictionary\":{\"ID\":3,\"CreatedAt\":\"2020-07-05T15:27:31+08:00\",\"UpdatedAt\":\"2020-07-05T15:27:31+08:00\",\"DeletedAt\":null,\"name\":\"数据库int类型\",\"type\":\"int\",\"status\":true,\"desc\":\"int类型对应的数据库类型\",\"sysDictionaryDetails\":[{\"ID\":12,\"CreatedAt\":\"2020-07-05T15:31:41+08:00\",\"UpdatedAt\":\"2020-07-05T15:31:41+08:00\",\"DeletedAt\":null,\"label\":\"smallint\",\"value\":1,\"status\":true,\"sort\":1,\"sysDictionaryID\":3},{\"ID\":13,\"CreatedAt\":\"2020-07-05T15:31:52+08:00\",\"UpdatedAt\":\"2020-07-05T15:31:52+08:00\",\"DeletedAt\":null,\"label\":\"mediumint\",\"value\":2,\"status\":true,\"sort\":2,\"sysDictionaryID\":3},{\"ID\":14,\"CreatedAt\":\"2020-07-05T15:32:04+08:00\",\"UpdatedAt\":\"2020-07-05T15:32:04+08:00\",\"DeletedAt\":null,\"label\":\"int\",\"value\":3,\"status\":true,\"sort\":3,\"sysDictionaryID\":3},{\"ID\":15,\"CreatedAt\":\"2020-07-05T15:32:11+08:00\",\"UpdatedAt\":\"2020-07-05T15:32:11+08:00\",\"DeletedAt\":null,\"label\":\"bigint\",\"value\":4,\"status\":true,\"sort\":4,\"sysDictionaryID\":3}]}},\"msg\":\"操作成功\"}'),(355,'2020-07-30 09:49:53','2020-07-30 09:49:53',NULL,'127.0.0.1','GET','/autoCode/getTables',200,472202,'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:78.0) Gecko/20100101 Firefox/78.0','','',10,'{\"code\":0,\"data\":{\"tables\":[{\"tableName\":\"authority_menu\"},{\"tableName\":\"casbin_rule\"},{\"tableName\":\"exa_customers\"},{\"tableName\":\"exa_file_chunks\"},{\"tableName\":\"exa_file_upload_and_downloads\"},{\"tableName\":\"exa_files\"},{\"tableName\":\"jwt_blacklists\"},{\"tableName\":\"sys_apis\"},{\"tableName\":\"sys_authorities\"},{\"tableName\":\"sys_authority_menus\"},{\"tableName\":\"sys_base_menus\"},{\"tableName\":\"sys_data_authority_id\"},{\"tableName\":\"sys_dictionaries\"},{\"tableName\":\"sys_dictionary_details\"},{\"tableName\":\"sys_operation_records\"},{\"tableName\":\"sys_users\"},{\"tableName\":\"sys_workflow_step_infos\"},{\"tableName\":\"sys_workflows\"}]},\"msg\":\"操作成功\"}');
...
-- Dump completed on 2020-07-30  9:54:45
