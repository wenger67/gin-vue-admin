<template>
  <div>
    ...
    >
      ...
      <el-table-column label="生产商" prop="company.fullName" min-width="60" align="center"></el-table-column>
      <el-table-column label="品牌" prop="brand" min-width="60" align="center"></el-table-column> 
      <el-table-column label="型号" prop="modal" min-width="60" align="center"></el-table-column> 
      <el-table-column label="载重" prop="load" min-width="60" align="center"></el-table-column> 
